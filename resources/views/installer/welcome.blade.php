...
<div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
    <div class="text-center mb-8">
        ...
        <h2 class="text-3xl font-bold text-gray-900 mb-2">Welcome to StockFlowPOS</h2>
        <p class="text-gray-600">Thank you for choosing StockFlowPOS. Let's get your POS system up and running!</p>
    </div>
