...
<div x-data="settingsData()" class="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
    ...
    <form @submit.prevent="submitForm()" class="space-y-6">
        <div>
            ...
            <input type="text" x-model="app_name" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="StockFlowPOS">
...
function settingsData() {
    return {
        ...
        init() {
            this.app_name = sessionStorage.getItem('app_name') || 'StockFlowPOS';
