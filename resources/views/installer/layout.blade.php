...
<head>
    ...
    <title>StockFlowPOS Installer - @yield('title')</title>
    ...
    <div class="min-h-screen flex flex-col">
        ...
        <header class="bg-white border-b border-gray-200">
            <div class="max-w-4xl mx-auto px-6 py-4">
                <div class="flex items-center justify-between">
                    <h1 class="text-2xl font-bold text-gray-900">StockFlowPOS Installation</h1>
        ...
        <footer class="bg-white border-t border-gray-200 py-6">
            <div class="max-w-4xl mx-auto px-6 text-center text-sm text-gray-500">
                <p>&copy; {{ date('Y') }} StockFlow Technologies. All rights reserved.</p>
            </div>
        </footer>
    </div>
