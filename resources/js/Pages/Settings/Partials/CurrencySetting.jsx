...
export default function CurrencySetting({ handleSubmit, settingFormData, handleChange }) {
    ...
    const getPreviewSettings = () => ({
        currency_symbol: settingFormData.currency_symbol || 'KSh',
        currency_code: settingFormData.currency_code || 'KES',
                        ...
                        >
                            ...
                            <Grid size={{ xs: 12, sm: 6 }}>
                                <TextField
                                    ...
                                    variant="outlined"
                                >
                                    <MenuItem value="before">Before Amount ({settingFormData.currency_symbol || 'KSh'} 1,500.00)</MenuItem>
                                    <MenuItem value="after">After Amount (1,500.00 {settingFormData.currency_symbol || 'KSh'})</MenuItem>
                                </TextField>
                            </Grid>
                            ...
                            <Grid size={{ xs: 12, sm: 6 }}>
                                <TextField
                                    ...
                                    variant="outlined"
                                >
                                    <MenuItem value="0">0 ({settingFormData.currency_symbol || 'KSh'} 1500)</MenuItem>
                                    <MenuItem value="2">2 ({settingFormData.currency_symbol || 'KSh'} 1500.00)</MenuItem>
                                    <MenuItem value="3">3 ({settingFormData.currency_symbol || 'KSh'} 1500.000)</MenuItem>
                                </TextField>
                            </Grid>
                            ...
                            <Grid size={{ xs: 12, sm: 6 }}>
                                <TextField
                                    ...
                                    variant="outlined"
                                >
                                    <MenuItem value="minus">With Minus Sign (-{settingFormData.currency_symbol || 'KSh'} 1,500.00)</MenuItem>
                                    <MenuItem value="parentheses">Parentheses (({settingFormData.currency_symbol || 'KSh'} 1,500.00))</MenuItem>
                                </TextField>
                            </Grid>
                            ...
                            <Grid size={{ xs: 12, sm: 6 }}>
                                <TextField
                                    ...
                                    variant="outlined"
                                >
                                    <MenuItem value="yes">Yes ({settingFormData.currency_symbol || 'KSh'} ({settingFormData.currency_code || 'KES'}) 1,500.00)</MenuItem>
                                    <MenuItem value="no">No ({settingFormData.currency_symbol || 'KSh'} 1,500.00)</MenuItem>
                                </TextField>
                            </Grid>
                        </Grid>
                    </Paper>
